...
module.exports = function (env) {
	return {
		entry: {
			...
			DeletePageContent: './src/api/deletePageContent/index.js',
			DeletePageContents: './src/api/deletePageContents/index.js',
			...
			GetPage: './src/api/getPage/index.js',
			GetPageContents: './src/api/getPageContents/index.js',
			GetPages: './src/api/getPages/index.js',
			...
			PatchPage: './src/api/patchPage/index.js',
			PatchPageContent: './src/api/patchPageContent/index.js',
			PatchPageContents: './src/api/patchPageContents/index.js',
			...
			PostPageContent: './src/api/postPageContent/index.js',
