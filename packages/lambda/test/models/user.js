...
describe('User', function () {
	...
	describe('#validate()', function () {
		const tests = [
			{model: TestHelper.generate.model('user'), param: 'uuid', value: null, error: true},
			{model: TestHelper.generate.model('user'), param: 'uuid', value: '1234567890', error: true},
			{model: TestHelper.generate.model('user'), param: 'uuid', value: '9ba33b63-41f9-4efc-8869-2b50a35b53df', error: false},
			{model: TestHelper.generate.model('user'), param: 'createdOn', value: null, error: true},
			{model: TestHelper.generate.model('user'), param: 'createdOn', value: 'test', error: true},
			{model: TestHelper.generate.model('user'), param: 'createdOn', value: '123456', error: true},
			{model: TestHelper.generate.model('user'), param: 'createdOn', value: 123456, error: false},
			{model: TestHelper.generate.model('user'), param: 'isDeleted', value: null, error: true},
			{model: TestHelper.generate.model('user'), param: 'isDeleted', value: 'test', error: true},
