...
describe('Donation', function () {
	...
	describe('#validate()', function () {
		const tests = [
			...
			{model: TestHelper.generate.model('donation'), param: 'isOfflineDonation', value: null, error: false},
			{model: TestHelper.generate.model('donation'), param: 'isOfflineDonation', value: '', error: false},
			...
			{model: TestHelper.generate.model('donation'), param: 'isOfflineDonation', value: false, error: false},
			...
			{model: TestHelper.generate.model('donation'), param: 'paymentTransactionUuid', value: null, error: true},
			{model: TestHelper.generate.model('donation'), param: 'paymentTransactionUuid', value: '1234567890', error: true},
			{model: TestHelper.generate.model('donation'), param: 'paymentTransactionUuid', value: '9ba33b63-41f9-4efc-8869-2b50a35b53df', error: false},
		];
