...
describe('PaymentTransaction', function () {
	...
	describe('#validate()', function () {
		const tests = [
			...
			{model: TestHelper.generate.model('paymentTransaction'), param: 'transactionAmountInCents', value: null, error: true},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'transactionAmountInCents', value: '', error: true},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'transactionAmountInCents', value: '123456', error: true},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'transactionAmountInCents', value: 123456, error: false},
