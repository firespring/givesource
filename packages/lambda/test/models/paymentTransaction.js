...
describe('PaymentTransaction', function () {
	...
	describe('#validate()', function () {
		const tests = [
			...
			{model: TestHelper.generate.model('paymentTransaction'), param: 'billingZip', value: 123456, error: false},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'creditCardCvvResult', value: null, error: true},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'creditCardCvvResult', value: '', error: true},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'creditCardCvvResult', value: '123456', error: false},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'creditCardCvvResult', value: 123456, error: false},
			...
			{model: TestHelper.generate.model('paymentTransaction'), param: 'creditCardName', value: 'Lit Fam', error: false},
			...
			{model: TestHelper.generate.model('paymentTransaction'), param: 'total', value: null, error: true},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'total', value: '', error: true},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'total', value: '123456', error: false},
			{model: TestHelper.generate.model('paymentTransaction'), param: 'total', value: 123456, error: false},
