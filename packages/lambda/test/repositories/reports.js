...
describe('ReportsRepository', function () {
	...
	describe('#get()', function () {
		...
		it('should return a Report model', function () {
			const data = TestHelper.generate.data('report');
	...
	describe('#getAll()', function () {
		...
		it('should return all Report models', function () {
			const count = 3;
			const data = TestHelper.generate.dataCollection('report', count);
	...
	describe('#save()', function () {
		...
		it('should update the Report model', function () {
		...
		it('should call reject for an invalid Report model', function () {
			...
			const repository = new ReportsRepository();
			return promiseMe.thatYouReject(repository.save(new Report()));
		});
