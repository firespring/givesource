...
(function () {
  ...
  function _wrapRegExp () {
    ...
    function buildGroups (e, t) {
      ...
      return Object.keys(p).reduce(function (r, t) {
        var o = p[t]
        if (typeof o === 'number') r[t] = e[o]; else {
    ...
    return _inherits(BabelRegExp, RegExp), BabelRegExp.prototype.exec = function (r) {
      ...
      if (typeof p === 'string') {
        ...
        return e[Symbol.replace].call(this, t, p.replace(/\$<([^>]+)(>|$)/g, function (e, r, t) {
          if (t === '') return e
          var p = o[r]
          return Array.isArray(p) ? '$' + p.join('$') : typeof p === 'number' ? '$' + p : ''
        }))
      }
      if (typeof p === 'function') {
        ...
        return e[Symbol.replace].call(this, t, function () {
          var e = arguments
          return typeof e[e.length - 1] !== 'object' && (e = [].slice.call(e)).push(buildGroups(e, i)), p.apply(this, e)
        })
      }
  ...
  function getCanonicalPrefix (styleOrPrefix) {
    ...
    var family = _params$family === void 0 ? i : _params$family
  ...
  function getCanonicalIcon (values) {
    ...
    var skipLookups = _params$skipLookups === void 0 ? false : _params$skipLookups
    ...
    var _faStyles$ = _faStyles[0]
    var styleFromValues = _faStyles$ === void 0 ? null : _faStyles$
  ...
  function applyShimAndAlias (skipLookups, givenPrefix, canonical) {
    ...
    var iconName = canonical.iconName
  ...
  function getDefaultCanonicalPrefix (prefixOptions) {
    ...
    var family = prefixOptions.family
    var canonical = prefixOptions.canonical
    var _prefixOptions$givenP = prefixOptions.givenPrefix
    var givenPrefix = _prefixOptions$givenP === void 0 ? '' : _prefixOptions$givenP
    var _prefixOptions$styles = prefixOptions.styles
    var styles = _prefixOptions$styles === void 0 ? {} : _prefixOptions$styles
    var _prefixOptions$config = prefixOptions.config
    var config$$1 = _prefixOptions$config === void 0 ? {} : _prefixOptions$config
  ...
  function convertSVG (abstractObj) {
    ...
    var ceFn = _params$ceFn === void 0 ? abstractObj.tag === 'svg' ? createElementNS : createElement : _params$ceFn
  ...
  function observe (options) {
    ...
    var treeCallback = _options$treeCallback === void 0 ? noop$2 : _options$treeCallback
    var _options$nodeCallback = options.nodeCallback
    var nodeCallback = _options$nodeCallback === void 0 ? noop$2 : _options$nodeCallback
    var _options$pseudoElemen = options.pseudoElementsCallback
    var pseudoElementsCallback = _options$pseudoElemen === void 0 ? noop$2 : _options$pseudoElemen
