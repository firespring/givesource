        ...
        <main class="o-app__main o-app__main--compact">
            <div class="o-app_main-content o-app_main-content">
                <div class="o-app-main-content">
                    ...
                    <donors-list-table></donors-list-table>

                    <div class="c-table-footer">

                        <div class="c-table-footer__actions">
                            <a href="#" class="c-btn c-btn--bad c-btn--sm c-btn--flat c-btn--icon js-modal-trigger" rel="modal-confirm-delete">
                                <i class="fa fa-fw fa-trash" aria-hidden="true"></i>Delete Selected
                            </a>
                        </div>
...
<script>
	module.exports = {
		components: {
			'donors-list-table': require('./DonorsListTable.vue')
		}
	};
</script>