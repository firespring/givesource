                                ...
                                <div class="c-form-item c-form-item--radio">
                                    ...
                                    <div class="c-form-item__control">
                                        <ul class="c-input-list c-input-list--radio" aria-labelledby="logoSize">
                                            <li>
                                                <input v-model="formData.logoSize" type="radio" id="logoSize-1" value="1">
                                                <label for="logoSize-1">Large</label>
                                            </li>
                                            <li>
                                                <input v-model="formData.logoSize" type="radio" id="logoSize-2" value="2">
                                                <label for="logoSize-2">Default</label>
                                            </li>
                                            <li>
                                                <input v-model="formData.logoSize" type="radio" id="logoSize-3" value="3">
