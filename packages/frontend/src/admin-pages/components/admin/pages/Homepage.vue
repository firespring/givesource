              ...
              <div class="c-page-section__main">
                <div class="c-form-item c-form-item--text">
                  ...
                  <div class="c-form-item__control">
                    <input
                      id="homepageTitle"
                      v-model="formData.contents.HOMEPAGE_TITLE.value"
                      type="text"
                      name="homepageTitle"
                    >
                  </div>
                ...
                <div class="c-form-item c-form-item--file c-form-item--file-picker">
                  <div class="c-form-item__label">
                    <label
                      for="homepageSpotlight"
                      class="c-form-item-label-text"
                    >Homepage Spotlight Image</label>
                  </div>
                  <forms-image-upload
                    id="homepageSpotlight"
                    v-model="formData.contents.HOMEPAGE_SPOTLIGHT.value"
                  ...
                  <div
                    v-if="formErrors['contents.HOMEPAGE_SPOTLIGHT.value']"
                ...
                <div class="c-form-item c-form-item--rich-text">
                  ...
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="headerText"
                      v-model="formData.contents.HOMEPAGE_MASTHEAD_TEXT.value"
                      :loaded="loaded"
                      type="basic"
                    />
                  </div>
                ...
                <div class="c-form-item c-form-item--rich-text">
                  ...
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="mainText"
                      v-model="formData.contents.HOMEPAGE_MAIN_TEXT.value"
                      :loaded="loaded"
                      type="advanced"
                    />
                  </div>
            ...
            <section class="c-page-section c-page-section--border c-page-section--shadow c-page-section--segmented">
              ...
              <div class="c-page-section__main">
                <div class="c-form-item c-form-item--text">
                  <div class="c-form-item__label">
                    <label
                      for="nonprofitRegistrationButtonLabel"
                      class="c-form-item-label-text"
                    >Registration Button Label</label>
                    <div class="c-notes">
                  ...
                  <div class="c-form-item__control">
                    <input
                      ...
                      v-model="formData.contents.HOMEPAGE_REGISTER_BUTTON.value"
                      type="text"
                      name="nonprofitRegistrationButtonLabel"
                    >
                  </div>
                </div>
                ...
                <div class="c-form-item c-form-item--rich-text">
                  ...
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="nonprofitDetailsText"
                      v-model="formData.contents.HOMEPAGE_REGISTER_DETAILS.value"
                      :loaded="loaded"
                      type="basic"
                    />
                  </div>
            ...
            <section class="c-page-section c-page-section--border c-page-section--shadow c-page-section--segmented">
              ...
              <div class="c-page-section__main">
                <div class="c-form-item c-form-item--checkbox">
                  <div class="c-form-item__control">
                    <ul
                      class="c-input-list c-input-list--checkbox"
                      aria-labelledby="enableMatchFunds"
                    >
                      <li
                        class="has-sub-options"
                        :class="{'has-sub-options--show': showMatchFundOptions}"
                      >
                        <input
                          id="enableMatchFunds-1"
                          v-model="formData.contents.HOMEPAGE_MATCH_IS_ENABLED.value"
                          type="checkbox"
                          name="enableMatchFunds"
                        >
                        ...
                        <div class="sub-options">
                          ...
                          >
                            <div class="c-form-item__label">
                              <label
                                for="matchFundNonprofitId"
                                class="c-form-item-label-text"
                              >Match Fund Nonprofit</label>
                            </div>
                            <div class="c-form-item__control">
                              <forms-select-nonprofit
                                id="matchFundNonprofitId"
                                v-model="formData.settings.MATCH_FUND_NONPROFIT_ID"
                                name="matchFundNonprofitId"
                                :nonprofits="nonprofits"
                                :has-error="formErrors.hasOwnProperty('settings.MATCH_FUND_NONPROFIT_ID')"
                              />
                              <div
                                v-if="formErrors['settings.MATCH_FUND_NONPROFIT_ID']"
                                class="c-notes c-notes--below c-notes--bad c-form-control-error"
                              >
                          ...
                          <div class="c-form-item c-form-item--text">
                            <div class="c-form-item__label">
                              <label
                                for="matchFundButtonLabel"
                                class="c-form-item-label-text"
                              >Match Fund Button Label</label>
                              <div class="c-notes">
                            ...
                            <div class="c-form-item__control">
                              <input
                                ...
                                v-model="formData.contents.HOMEPAGE_MATCH_BUTTON.value"
                                type="text"
                                name="matchFundButtonLabel"
                              >
                            </div>
                          </div>
                          ...
                          <div class="c-form-item c-form-item--text">
                            <div class="c-form-item__label">
                              <label
                                for="matchFundDetails"
                                class="c-form-item-label-text"
                              >Match Fund Details Text</label>
                              <div class="c-notes">
                            ...
                            <div class="c-form-item__control">
                              <input
                                id="matchFundDetails"
                                v-model="formData.contents.HOMEPAGE_MATCH_DETAILS.value"
                                type="text"
                                name="matchFundDetails"
                              >
                            </div>
                          </div>
                        </div>
            ...
            <section class="c-page-section c-page-section--border c-page-section--shadow c-page-section--segmented">
              ...
              <div class="c-page-section__main">
                <div class="c-form-item c-form-item--rich-text">
                  ...
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="postEventDetailsText"
                      v-model="formData.contents.HOMEPAGE_POST_EVENT_TEXT.value"
                      :loaded="loaded"
                      type="advanced"
                    />
                  </div>
