                    ...
                    <form v-on:submit="submit">
                            ...
                            <div class="c-page-section__main">
                                <div class="c-form-item c-form-item--rich-text">
                                    <div class="c-form-item__control">
                                        <forms-ckeditor v-model="formData.REGISTER_FORM_TEXT.value" :loaded="loaded" id="formText" type="advanced"></forms-ckeditor>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="c-page-section c-page-section--border c-page-section--shadow">
                            ...
                            <div class="c-page-section__main">
                                <div class="c-form-item c-form-item--rich-text">
                                    <div class="c-form-item__control">
                                        <forms-ckeditor v-model="formData.REGISTER_RESPONSE_TEXT.value" :loaded="loaded" id="responseText" type="advanced"></forms-ckeditor>
                                    </div>
                                </div>
                            </div>
                        </section>
