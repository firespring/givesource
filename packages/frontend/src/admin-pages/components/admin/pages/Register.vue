                ...
                <div class="o-app-main-content">
                    ...
                    <div class="o-page-header">
                        <div class="o-page-header__text">
                            ...
                            <h1 class="o-page-header-title">Register</h1>
                        </div>
                    </div>
                    ...
                    <form v-on:submit="submit">
                            ...
                            <div class="c-page-section__main">
                                <div class="c-form-item c-form-item--rich-text">
                                    <div class="c-form-item__control">
                                        <forms-ckeditor v-model="formData.REGISTER_FORM_TEXT.value" :loaded="loaded" id="formText" type="Advanced" :allowImages="true">
                                        </forms-ckeditor>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section class="c-page-section c-page-section--border c-page-section--shadow">
                            ...
                            <div class="c-page-section__main">
                                <div class="c-form-item c-form-item--rich-text">
                                    <div class="c-form-item__control">
                                        <forms-ckeditor v-model="formData.REGISTER_RESPONSE_TEXT.value" :loaded="loaded" id="responseText" type="Advanced" :allowImages="true">
                                        </forms-ckeditor>
                                    </div>
                                </div>
                            </div>
