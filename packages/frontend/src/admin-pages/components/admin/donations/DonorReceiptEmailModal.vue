                    ...
                    <div class="c-modal-content">
                            ...
                            <div class="c-page-section__main">
                                ...
                                <fieldset class="c-page-section__fieldset" aria-labelledby="section-donor-email">
                                    <div class="u-control-icon u-control-icon--email has-floating-label has-floating-label--blank js-floating-label" v-floating-label>
                                        <input v-model="formData.TO_EMAIL" type="email" name="toEmail" id="toEmail" :class="{ 'has-error': formErrors.TO_EMAIL }" v-auto-focus>
                                        <label for="toEmail">Send To Email Address</label>
                                    </div>
                                    <div v-if="formErrors.TO_EMAIL" class="c-notes c-notes--below c-notes--bad c-form-control-error">
                                        {{ formErrors.TO_EMAIL }}
                                    </div>
                        ...
                        <div class="c-modal-footer">
                            <div class="c-modal-footer__actions">
                                <button v-on:click.prevent="send" class="c-btn">Send</button>
