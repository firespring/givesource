      ...
      <form @submit="submit">
        <div class="c-form-control-grid">
          <div class="c-form-control-grid__item u-flex-collapse">
            <select
              id="selectMenuDefault"
              v-model="sort"
              name="selectMenuDefault"
              class="sm u-width-auto"
              @change="updateSort"
            >
              <option value="all_created_on_descending">
                View all nonprofits
              </option>
              <option value="active_legal_name_descending">
                View active
              </option>
              <option value="pending_legal_name_descending">
                View pending
              </option>
              <option value="denied_legal_name_descending">
                View denied
              </option>
            </select>
          </div>
