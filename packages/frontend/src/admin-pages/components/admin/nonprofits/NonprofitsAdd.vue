                ...
                <div class="o-app-main-content">
                    ...
                    <div class="o-page-header">
                        <div class="o-page-header__text">
                            ...
                            <h1 class="o-page-header-title">Add Nonprofit Organization</h1>
                        </div>
                    </div>
                            ...
                            <div class="c-page-section__main">
                                ...
                                <div class="c-form-item c-form-item--text c-form-item--required" :class="{ 'c-form-item--has-error': formErrors.legalName }">
                                    ...
                                    <div class="c-form-item__control">
                                        <input v-model="formData.legalName" type="text" name="legalName" id="legalName" maxlength="200"
                                               :class="{ 'has-error': formErrors.legalName }" v-auto-focus>
                                ...
                                <div class="c-form-item c-form-item--text c-form-item--required">
                                    ...
                                    <div class="c-form-item__control">
                                        ...
                                        <div v-if="formErrors.firstName || formErrors.lastName"
                                             class="c-notes c-notes--below c-notes--bad c-form-control-error u-margin-bottom-thick">
