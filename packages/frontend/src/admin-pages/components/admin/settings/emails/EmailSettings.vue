              ...
              <div class="c-page-section__main">
                <div class="c-form-item c-form-item--textarea">
                  <div class="c-form-item__label">
                    <label
                      for="donationNotificationTextBefore"
                      class="c-form-item-label-text"
                    >Text Before Donation Details</label>
                  </div>
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="donationNotificationTextBefore"
                      v-model="formData.EMAILS_DONATION_NOTIFICATION_BEFORE"
                      :loaded="loaded"
                    />
                    <div class="c-notes c-notes--below">
                    ...
                    <div
                      v-if="formErrors.EMAILS_DONATION_NOTIFICATION_BEFORE"
                ...
                <div class="c-form-item c-form-item--textarea">
                  <div class="c-form-item__label">
                    <label
                      for="donationNotificationTextAfter"
                      class="c-form-item-label-text"
                    >Text After Donation Details</label>
                  </div>
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="donationNotificationTextAfter"
                      v-model="formData.EMAILS_DONATION_NOTIFICATION_AFTER"
                      :loaded="loaded"
                    />
                    <div class="c-notes c-notes--below">
                    ...
                    <div
                      v-if="formErrors.EMAILS_DONATION_NOTIFICATION_AFTER"
                      class="c-notes c-notes--below c-notes--bad c-form-control-error"
                    >
            ...
            <section class="c-page-section c-page-section--border c-page-section--shadow c-page-section--segmented">
              ...
              <div class="c-page-section__main">
                <div class="c-form-item c-form-item--textarea">
                  <div class="c-form-item__label">
                    <label
                      for="donationReceiptTextBefore"
                      class="c-form-item-label-text"
                    >Text Before Donations List</label>
                  </div>
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="donationReceiptTextBefore"
                      v-model="formData.EMAILS_DONATION_RECEIPT_BEFORE_LIST"
                      :loaded="loaded"
                    />
                    <div class="c-notes c-notes--below">
                    ...
                    <div
                      v-if="formErrors.EMAILS_DONATION_RECEIPT_BEFORE_LIST"
                      class="c-notes c-notes--below c-notes--bad c-form-control-error"
                    >
                ...
                <div class="c-form-item c-form-item--textarea">
                  <div class="c-form-item__label">
                    <label
                      for="donationReceiptTextAfter"
                      class="c-form-item-label-text"
                    >Text After Donations List</label>
                  </div>
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="donationReceiptTextAfter"
                      v-model="formData.EMAILS_DONATION_RECEIPT_AFTER_LIST"
                      :loaded="loaded"
                    />
                    <div class="c-notes c-notes--below">
                    ...
                    <div
                      v-if="formErrors.EMAILS_DONATION_RECEIPT_AFTER_LIST"
                      class="c-notes c-notes--below c-notes--bad c-form-control-error"
                    >
            ...
            <section class="c-page-section c-page-section--border c-page-section--shadow c-page-section--segmented">
              ...
              <div class="c-page-section__main">
                <div class="c-form-item c-form-item--textarea">
                  <div class="c-form-item__label">
                    <label
                      for="userRegistrationPending"
                      class="c-form-item-label-text"
                    >Message</label>
                  </div>
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="userRegistrationPending"
                      v-model="formData.EMAILS_USER_REGISTRATION_PENDING"
                      :loaded="loaded"
                    />
                    <div class="c-notes c-notes--below">
                    ...
                    <div
                      v-if="formErrors.EMAILS_USER_REGISTRATION_PENDING"
                      class="c-notes c-notes--below c-notes--bad c-form-control-error"
                    >
            ...
            <section class="c-page-section c-page-section--border c-page-section--shadow c-page-section--segmented">
              ...
              <div class="c-page-section__main">
                <div class="c-form-item c-form-item--textarea">
                  <div class="c-form-item__label">
                    <label
                      for="userRegistrationActivated"
                      class="c-form-item-label-text"
                    >Additional Message</label>
                  </div>
                  <div class="c-form-item__control">
                    <forms-ckeditor
                      id="userRegistrationActivated"
                      v-model="formData.EMAILS_USER_REGISTRATION_ACTIVATED"
                      :loaded="loaded"
                    />
                    <div class="c-notes c-notes--below">
                    ...
                    <div
                      v-if="formErrors.EMAILS_USER_REGISTRATION_ACTIVATED"
                      class="c-notes c-notes--below c-notes--bad c-form-control-error"
                    >
