            ...
            <div class="c-page-section__main">
              <div class="c-page-section-segment o-grid o-grid--sm-middle">
                <div class="o-grid-col o-grid-col--sm-expand">
                  ...
                  <div class="u-break-word">
                    {{ contactEmail }}{{ contactEmailVerificaitonMessage }}
                  </div>
                  <div class="c-notes c-notes--below">
                    ...
                    <span v-if="displayResendContactEmailVerificationLink">
                      ...
                      <a
                        href="#"
                        @click.prevent="resendContactEmailVerification"
                      >
                ...
                <div class="o-grid-col o-grid-col--sm-shrink">
                  <a
                    ...
                    @click.prevent="editContactEmail"
                  >
                    <i
                      class="fa fa-pencil"
                      aria-hidden="true"
              ...
              <div class="c-page-section-segment o-grid o-grid--sm-middle">
                <div class="o-grid-col o-grid-col--sm-expand">
                  ...
                  <div class="u-break-word">
                    {{ senderEmail }}{{ senderEmailVerificaitonMessage }}
                  </div>
                  ...
                  <div class="c-notes c-notes--below">
                    ...
                    <span v-if="displayResendSenderEmailVerificationLink">
                      ...
                      <a
                        href="#"
                        @click.prevent="resendSenderEmailVerification"
                      >
                        Resend Verification Link
                      </a>
                    </span>
                  ...
                  <div
                    v-if="senderEmailIsVerified && cognitoSenderEmailAddress"
                    class="c-notes c-notes--below"
                  >
                    <a
                      v-if="!isCognitoSenderEmailAddress"
                      href="#"
                      @click.prevent="setCognitoSenderEmail"
                    >
              ...
              <div class="c-page-section-segment o-grid o-grid--sm-middle">
                ...
                <div class="o-grid-col o-grid-col--sm-shrink">
                  <a
                    ...
                    role="button"
                    class="c-btn c-btn--xs c-btn--flat c-btn--icon"
                    @click.prevent="editContactPhone"
                  >
                    <i
                      class="fa fa-pencil"
                      aria-hidden="true"
